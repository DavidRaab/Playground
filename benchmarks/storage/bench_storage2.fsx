...
let stoP = Storage2.create ()
let stoS = Storage2.create ()

let amount = 50_000
for i=1 to amount do
    Storage2.insert i (createTransformP ()) stoP
for i=1 to amount do
    Storage2.insert i (createTransformS ()) stoS

// just iterate through both and count items
let (countP, timeP) = countIt 10_000 (fun () ->
    let mutable count = 0f
    stoP |> Storage2.iter (fun k t ->
